...
import { Creators as TodoActions } from "../../redux/news";
...
function* fetchPosts() {
    try {
        ...
        const posts = yield call(fetchPostsByChannelName, allState.news.channelName);
        yield put(TodoActions.receivePosts(posts)); // after geting post value dispatch another action
    } catch (e) {
        console.log(e);
    }
}
